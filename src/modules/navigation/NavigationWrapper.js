  ...
  class WrappingComponent extends Component {
    ...
    onNavigatorEvent(event) {
      if (event.type === 'DeepLink') {
        ...
        let screenObj;
        switch (link) {
          case WIDGET_SCREEN.screen:
            screenObj = {...WIDGET_SCREEN};
            break;
          case FACEBOOK_ACCEPT_SIGNUP_SCREEN.screen:
            screenObj = {...FACEBOOK_ACCEPT_SIGNUP_SCREEN};
            break;
          case FACEBOOK_SIGNUP_SCREEN.screen:
            screenObj = {...FACEBOOK_SIGNUP_SCREEN};
            break;
