...
import {FACEBOOK_SIGNUP_SCREEN,PERSONAL_INFO_SCREEN,TERM_OF_USE_SCREEN} from '../../../screens';
type State = {
  username: string,
  password: string,
};
...
`;
class FacebookAcceptSignupView extends Component<Props, State> {
  state = {
    username: '',
    password: '',
  };
  ...
  goToFacebookSignup(){
    if(this.state.checked2===true && this.state.checked3===true) {
      console.log("this.props",this.props.name, this.props.email);
      this.props.navigator.push({
        ...FACEBOOK_SIGNUP_SCREEN, passProps: {
...
- 보유 및 이용기간 : 회원탈퇴 후 5일까지
        ...
        <NavButton
          ...
          onPress={()=> this.goToFacebookSignup()
          }
        >
...
export default FacebookAcceptSignupView;
