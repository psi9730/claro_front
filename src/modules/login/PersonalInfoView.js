...
class PersonalInfoView extends Component<Props, State> {
  ...
  render() {
    return (
          <Container>
            <LoginText style={{flexGrow:0, flexShrink:0, flexBasis: 'auto', fontSize: 20, marginBottom: 40, backgroundColor:'white', color: 'black', fontWeight:'bold'}}>
              개인정보 수집 및 이용
            </LoginText>
            <View style={{flex:1, alignSelf: 'flex-start', paddingBottom:35, paddingLeft: 30, paddingRight:30, display: 'flex', flexDirection:'column',justifyContent: 'flex-start',alignItems:'flex-start'}}>
              <ScrollView style={ {flexGrow:1}} contentContainerStyle={{flexGrow: 1, display:'flex',flexDirection:'column',justifyContent: 'flex-start', alignItems:'flex-start'}}>
                <Text1>1. -목적: 이용자 식별 및 본인여부 확인</Text1>
                <Text1>   -항목: 이름, 아이디, 비밀번호</Text1>
                <Text1>   -보유 및 이용기간 : 회원탈퇴 후 5일까지</Text1>
                <Text1> </Text1>
                <Text1>2. -목적: 민원 등 고객 고충처리</Text1>
                <Text1>   -항목: 이메일, 휴대전화번호</Text1>
                <Text1>   -보유 및 이용기간 : 회원탈퇴 후 5일까지</Text1>
                <Text1> </Text1>
                <Text1>3. -목적: 만 14세 미만 아동 확인</Text1>
                <Text1>   -항목: 법적 생년월일</Text1>
                <Text1>   -보유 및 이용기간 : 회원탈퇴 후 5일까지</Text1>
              </ScrollView>
            </View>
          </Container>
